...
namespace TravelCompanion.Modules.TravelPlans.Api.Endpoints.Commands.TravelPointUpdateRequests.AcceptTravelPointUpdateRequest;
    ...
    .WithActionResult
{
    ...
    [Authorize]
    [HttpPut("Point/Update/{requestId:guid}/Acceptance")]
    [SwaggerOperation(
