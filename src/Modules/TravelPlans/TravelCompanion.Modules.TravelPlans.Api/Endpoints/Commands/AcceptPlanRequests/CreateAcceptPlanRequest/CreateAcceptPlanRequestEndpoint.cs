...
namespace TravelCompanion.Modules.TravelPlans.Api.Endpoints.Commands.AcceptPlanRequests.CreateAcceptPlanRequest;
    ...
    .WithActionResult
{
    ...
    public override async Task<ActionResult> HandleAsync([FromRoute] Application.AcceptPlanRequests.Commands.CreateAcceptPlanRequest command, CancellationToken cancellationToken = default)
    {
